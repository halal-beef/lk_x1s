...
#define EXYNOS3830_PREEMPT_BUF_BASE		(EXYNOS3830_DUMP_ACPM_BASE + 0x9800 - 0x3000)
#define EXYNOS3830_PREEMPT_BUF_SIZE		(0x1F00)
#define EXYNOS3830_PREEMPT_LOG_SIZE		(0x10)
#define EXYNOS3830_PREEMPT_BUF_START		(EXYNOS3830_PREEMPT_BUF_BASE + EXYNOS3830_PREEMPT_LOG_SIZE)
#define EXYNOS3830_PREEMPT_BUF_END		(EXYNOS3830_PREEMPT_BUF_BASE + EXYNOS3830_PREEMPT_BUF_SIZE - \
										EXYNOS3830_PREEMPT_LOG_SIZE)
#define EXYNOS3830_NOT_IDLE_MAGIC1		(0x5F544F4E)	// "NOT_"
#define EXYNOS3830_NOT_IDLE_MAGIC2		(0x454C4449)	// "IDLE"
