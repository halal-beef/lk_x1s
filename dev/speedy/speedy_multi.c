...
static void speedy_fifo_reset(unsigned int SPEEDY_BASE)
{
...
static void speedy_set_cmd(unsigned int SPEEDY_BASE, int direction, u16 address, int random, int burst_length)
{
...
static int speedy_wait_transfer_done(unsigned int SPEEDY_BASE)
{
...
static void speedy_swreset(unsigned int SPEEDY_BASE)
{
	u32 speedy_ctl = readl(SPEEDY_BASE + SPEEDY_CTRL);
