...
#define GPIO_DAT_FG_SHIFT_S2MU106		(0)
#define GPIO_PUD_FG_S2MU106	GPP0PUD &= ~(0xff << (GPIO_DAT_FG_SHIFT_S2MU106*4))

#define IIC_S2MU106_FG_ESCL_Hi	GPP0DAT |= (0x1 << (GPIO_DAT_FG_SHIFT_S2MU106+1))
#define IIC_S2MU106_FG_ESCL_Lo	GPP0DAT &= ~(0x1 << (GPIO_DAT_FG_SHIFT_S2MU106+1))
#define IIC_S2MU106_FG_ESDA_Hi	GPP0DAT |= (0x1 << GPIO_DAT_FG_SHIFT_S2MU106)
#define IIC_S2MU106_FG_ESDA_Lo	GPP0DAT &= ~(0x1 << GPIO_DAT_FG_SHIFT_S2MU106)

#define IIC_S2MU106_FG_ESCL_INP	GPP0CON &= ~(0xf << ((GPIO_DAT_FG_SHIFT_S2MU106+1)*4))
#define IIC_S2MU106_FG_ESCL_OUTP	GPP0CON = (GPP0CON & ~(0xf << ((GPIO_DAT_FG_SHIFT_S2MU106+1)*4))) \
					| (0x1 << ((GPIO_DAT_FG_SHIFT_S2MU106+1)*4))
#define IIC_S2MU106_FG_ESDA_INP	GPP0CON &= ~(0xf << (GPIO_DAT_FG_SHIFT_S2MU106*4))
#define IIC_S2MU106_FG_ESDA_OUTP	GPP0CON = (GPP0CON & ~(0xf << (GPIO_DAT_FG_SHIFT_S2MU106*4))) \
					 | (0x1 << (GPIO_DAT_FG_SHIFT_S2MU106*4))
